...
{
	int a;
	double h, S, R, r;//введення змінних
	...
	if (a > 0) {
		...
		h = sqrt(pow(a, 2) -pow(0.5*a, 2));    //формула висоти в рівностороньому трикутнику
		S = (0.5 * a * h);//формула площі рівносторонього трикутника
